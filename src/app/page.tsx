        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {portfolio.caseStudies.map((project, idx) => {
              ...
              return (
                <ScrollReveal key={idx} delay={idx * 90} className="flex flex-col h-full">
                  <div
                    className="group flex flex-col h-full rounded-2xl border border-warm-border bg-white hover:border-accent/40 shadow-[0_2px_8px_rgba(26,26,26,0.02)] hover:shadow-[0_8px_24px_rgba(26,26,26,0.06)] hover:-translate-y-1.5 transition-custom overflow-hidden"
                  >
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <ScrollReveal delay={0}>
              <div className="p-6 rounded-2xl border border-warm-border bg-white shadow-[0_2px_8px_rgba(26,26,26,0.02)] transition-custom hover:border-accent/40 hover:shadow-[0_8px_24px_rgba(26,26,26,0.06)] hover:-translate-y-1 h-full">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {portfolio.education.map((edu, idx) => (
              <ScrollReveal key={idx} delay={idx * 90} className="flex flex-col h-full">
                <div 
                  className="p-6 rounded-2xl border border-warm-border bg-white shadow-[0_2px_8px_rgba(26,26,26,0.02)] transition-custom hover:border-accent/40 hover:shadow-[0_8px_24px_rgba(26,26,26,0.06)] hover:-translate-y-1 flex flex-col justify-between h-full"
                >
                  <div>
                    <span className="text-xs font-bold uppercase tracking-wider text-accent block mb-1">
