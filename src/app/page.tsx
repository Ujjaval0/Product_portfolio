    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section id="hero" className="relative overflow-hidden pt-6 pb-6 px-6 md:pt-10 md:pb-16 md:px-4 border-b border-warm-border/60 bg-transparent">
        <div className="relative mx-auto max-w-6xl pt-0">
          ...
          <h1 className="font-sans text-[3.2rem] md:text-[95px] lg:text-[105px] font-extrabold font-[800] md:font-bold md:font-[700] text-[#1a1a2e] tracking-[-0.02em] md:tracking-[-4px] leading-[1.1] md:leading-[1.05] mb-6 md:mb-8 ml-0 pl-0">
